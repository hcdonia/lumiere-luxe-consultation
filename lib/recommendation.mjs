...
- HARD RULE — The Mini Luxe contains NO highlights: no foils, no babylights, no balayage, no lightener anywhere on the head. If the guest wants highlights in ANY amount — including a first-time color guest or a teen asking for "just a few", "nothing crazy", or "a little brightness" — you must NOT recommend The Mini Luxe. Recommend The Natural Luxe for subtle brightness or The New Luxe for noticeable brightness. The Mini Luxe is only for gray blending/coverage, toning down, a gloss, or a face-frame money piece with nothing through the rest of the hair.
